...
public final class QueryUtils {
    ...
    /**
     * Query the books dataset and return a list of {@link Books} objects.
     */
    public static List<Books> fetchBooksData(String requestUrl) {

        /*// Test to view the progress indicator when loading
        try {
            Thread.sleep(2000);
    ...
    private static List<Books> extractFeatureFromJson(String booksJSON) {
        ...
        try {
            ...
            // For each book in the earthquakeArray, create an {@link Books} object
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                // Create a new {@link Books} object with the title from the JSON response.
